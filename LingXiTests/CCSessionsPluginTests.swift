...
struct CCSessionsPluginTests {
    ...
    @Test func cacheMemoryCacheStoresAndRetrieves() async throws {
        ...
        LuaSandbox.apply(to: state)
        LuaSandbox.setupPackagePath(to: state, pluginDir: tmpDir.path)
        LuaAPI.registerAll(state: state, permissions: PermissionConfig(network: false, clipboard: false, filesystem: [], shell: [], notify: false, store: false, webview: false, cache: true), pluginId: "test.cache", pluginDir: tmpDir.path)
    ...
    @Test func readerHandlesCorruptedJSONL() async throws {
        ...
        LuaSandbox.apply(to: state)
        LuaSandbox.setupPackagePath(to: state, pluginDir: tmpDir.path)
        LuaAPI.registerAll(state: state, permissions: PermissionConfig(network: false, clipboard: false, filesystem: [tmpDir.path], shell: [], notify: false, store: false, webview: false, cache: false), pluginId: "test.reader", pluginDir: tmpDir.path)
    ...
    @Test func previewHandlesEmptySession() async throws {
        ...
        LuaSandbox.apply(to: state)
        LuaSandbox.setupPackagePath(to: state, pluginDir: tmpDir.path)
        LuaAPI.registerAll(state: state, permissions: PermissionConfig(network: false, clipboard: false, filesystem: [], shell: [], notify: false, store: false, webview: false, cache: false), pluginId: "test.preview", pluginDir: tmpDir.path)
    ...
    @Test func pluginSearchFunctionExists() async throws {
        ...
        LuaAPI.registerAll(state: state, permissions: PermissionConfig(network: false, clipboard: true, filesystem: ["/tmp"], shell: ["git"], notify: false, store: true, webview: true, cache: true), pluginId: "io.github.airead.lingxi.cc-sessions", pluginDir: pluginDir.path)
